...
company_name = st.text_input('Enter a stock symbol (e.g. AAPL)', 'RELIANCE.NS', key='symbol-input4')

now = dt.date.today()
now = now.strftime('%m-%d-%Y')
yesterday = dt.date.today() - dt.timedelta(days = 15)
...
#fig = px.pie(sizes, values='Count',names=sizes, title="Sentiment Analysis Result for stock= "+company_name+"" ,
#width=600, height=400)
#fig.show()

# Word cloud visualizati
#stopwords = set(STOPWORDS)
#allWords = ' '.join([nws for nws in texts])
